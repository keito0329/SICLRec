...
def parse_args():
    ...
    if args.model_type.lower() == 'bsarec':
        ...
        parser.add_argument('--use_rehearsal_buffer', default=False, action='store_true',
                    help='Enable the rehearsal buffer mechanism')
        parser.add_argument('--buffer_max_size', type=int,
                        help='Maximum number of samples to store in the rehearsal buffer')

    if args.model_type.lower() == 'mixedbsarec':
        parser.add_argument("--c", default=3, type=int)
    ...
    elif args.model_type.lower() == 'cfit4srec':
        parser.add_argument("--tau", default=1.0, type=float)
        parser.add_argument("--lmd", default=0.1, type=float)
        parser.add_argument("--lmd_sem", default=0.1, type=float)
        parser.add_argument("--ssl", default='dhiha', type=str)
        parser.add_argument("--sim", default='dot', type=str)
        parser.add_argument("--l_ok", default='True', type=str)
        parser.add_argument("--h_ok", default='True', type=str)
        parser.add_argument("--b_ok", default='True', type=str)
        parser.add_argument("--loss_type", default='CE', type=str)

    elif args.model_type.lower() == 'cl4srec':
        parser.add_argument("--tau", default=1.0, type=float)
        parser.add_argument("--lmd", default=0.1, type=float)
        parser.add_argument("--lmd_sem", default=0, type=float)
        parser.add_argument("--ssl", default='un', type=str)
        parser.add_argument("--sim", default='dot', type=str)


    elif args.model_type.lower() == 'myfreqrec':
        parser.add_argument("--alpha", default=0.9, type=float)
        parser.add_argument("--tau", default=1.0, type=float)
        parser.add_argument("--lmd", default=0.125, type=float)
        parser.add_argument("--lmd_sem", default=0.1, type=float)
        parser.add_argument("--ssl", default='usa', type=str)
        parser.add_argument("--sim", default='dot', type=str)
        parser.add_argument("--fredom_type", default='usa', type=str)
        parser.add_argument("--fredom", default='True', type=str) # use eval function to use as boolean
        parser.add_argument("--temperature", default=0.5, type=float, help="temperature for contrastive learning")

    elif args.model_type.lower() == 'myfreqrec2':
        parser.add_argument("--alpha", default=0.9, type=float)
        parser.add_argument("--tau", default=1.0, type=float)
        parser.add_argument("--lmd", default=0.125, type=float)
        parser.add_argument("--lmd_sem", default=0.1, type=float)
        parser.add_argument("--ssl", default='us', type=str)
    ...
    elif args.model_type.lower() == 'myfreqrec3':
        parser.add_argument("--alpha", default=0.9, type=float)
        parser.add_argument("--tau", default=1.0, type=float)
        parser.add_argument("--lmd", default=0.125, type=float)
        parser.add_argument("--lmd_sem", default=0.1, type=float)
